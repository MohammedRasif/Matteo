...
export const authApi = createApi({
    ...
    baseQuery: fetchBaseQuery({
        baseUrl: "http://192.168.10.124:2000/api/v1", //  Update this with your backend URL
    }),
    endpoints: (builder) => ({
...
export const { 
    useRegisterMutation,useLoginMutation,useRegisterVerificationMutation, useResendOtpMutation, useForgetPasswordMutation, useForgetPasswordVerificationMutation, useConfirmPasswordMutation
 } = authApi;
