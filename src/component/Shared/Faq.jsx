    ...
    return (
        <div className="">
            <div
                ...
                className={`py-4 text-[#345168] bg-white px-3 border border-gray-300 text-left text-base font-medium flex justify-between items-center w-full hover:cursor-pointer ${activeItem === index ? "rounded-t-xl" : "rounded-xl"
                    }`}
            >
            ...
            <div
                className={`overflow-hidden transition-all duration-300 ease-in-out bg-white ${activeItem === index
