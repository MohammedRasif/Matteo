...
import registration_img from "../image/Maskgroup.png"; // Adjust path as needed
	...
	return (
		<div className="flex items-center justify-between w-full min-h-screen gap-10 nunito">
			...
			<div className="w-1/2 lg:px-40">
				...
				<div className="p-4">
					<div className="w-full rounded-lg bg-[#848239] py-14 shadow-md">
						<div className="flex flex-col items-center justify-center space-y-6">
							{/* Success Icon */}
							<div className="flex h-16 w-16 items-center justify-center rounded-full bg-[#848239] text-white">
								<svg
							...
							<Link
								to="/login"
								className="flex items-center justify-center rounded-[8px] bg-[#848239] px-4 py-2 text-[#F6F8FA] w-[194px] transition-colors"
							>
								<svg
									xmlns="http://www.w3.org/2000/svg"
