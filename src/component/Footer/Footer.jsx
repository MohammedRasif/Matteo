					...
					<div>
						<div className="mb-8 max-w-md">
							<p className="text-sm md:text-base text-gray-500 leading-relaxed mt-4">
								The name "Chaskix" honors the legendary Andean
								messengers, known for their strength, agility,
								and resourcefulness. Just like them, we deliver
								fast, reliable, and impactful solutions to
