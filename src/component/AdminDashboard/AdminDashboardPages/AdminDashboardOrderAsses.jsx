  ...
  return (
    <div className="p-6 roboto">
      ...
      <div className="flex flex-col lg:flex-row gap-3 h-screen" style={{ height: "78vh" }}>
        ...
        <div className="lg:w-1/2 bg-white rounded-lg p- cool6">
          <div className="flex items-center gap-2 mb-4">
            <span className="text-md font-bold">Deliver files:</span>
            <span className="text-blue-500 underline text-sm cursor-pointer">View</span>
          </div>
          {/* Map project details */}
              ...
              >
                <div
                  className={`rounded-lg p-3 max-w-xs text-sm ${
                    message.buyer !== null ? "bg-blue-500 text-white" : "bg-gray-200 text-gray-800"
                  }`}
                >
