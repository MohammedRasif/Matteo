...
const AdminDashboardUser = () => {
	...
	const { data: managementDetails, isLoading: isDetailsLoading } =
		useManagementUserDetailsQuery(selectedUserId, {
			skip: !selectedUserId,
		});

	// Filter users based on search query
	const filteredUsers = management
		? management.filter((user) =>
				user.user_id
					.toString()
					.toLowerCase()
	...
	useEffect(() => {
		const handleClickOutside = (event) => {
			const isOutsideDropdown = dropdownRefs.current.every(
			...
			<div className="mx-auto">
				...
				<div className="rounded-md">
					...
					<div className="grid grid-cols-5 bg-gray-300 py-2 px-4 border-b border-gray-200">
						<div className="font-bold text-gray-700 text-[14px]">
							User ID
						</div>
						<div className="font-bold text-gray-700 text-[14px]">
							Starting Date
						...
						{isDetailsLoading ? (
							...
							<div className="px-2">
								<div className="flex items-center mb-4">
									<img
										src={
											(managementDetails.user.image &&
												`${BaseUrl}${managementDetails.user.image}`) ||
											"/placeholder.png"
										}
									...
									<div>
										<h3 className="text-lg font-medium text-gray-900">
											{managementDetails.user.username}
										</h3>
										<p className="text-sm text-gray-500">
											{managementDetails.user.role}
										</p>
										<div className="flex items-center mt-1">
											<span className="text-sm text-gray-600">
												Rating:{" "}
												{managementDetails.rating_sum}
											</span>
											...
											<span className="text-sm text-blue-500 cursor-pointer">
												(
												{managementDetails.rating_count}{" "}
												Reviews)
											</span>
										</div>
									</div>
								...
								<div className="grid grid-cols-2 gap-4 mb-4">
									<div>
										...
										<p className="text-sm font-medium">
											{
												managementDetails.task_completed_count
											}
										</p>
									</div>
									<div>
									...
									<div>
										...
										<p className="text-sm font-medium">
											{
												managementDetails.task_completed_amount
											}
										</p>
									</div>
									<div>
										...
										<p className="text-sm font-medium">
											{managementDetails.user.hourly_rate}
										</p>
									</div>
								...
								<div className="mb-4">
									...
									<p className="text-xs text-gray-600">
										{managementDetails.user.skills.join(
											", "
										)}
									</p>
								</div>
								...
								<div className="grid grid-cols-2 gap-4">
									<div>
										...
										<p className="text-sm font-medium">
											{managementDetails.user.languages.join(
												", "
											)}
										</p>
									</div>
					...
					>
						...
						<div className="flex justify-end gap-2">
							...
							<button
								...
								className={`px-4 py-2 bg-red-500 text-white rounded-md hover:bg-red-600 text-[15px] ${
									isDeleting
