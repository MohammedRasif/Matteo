...
const AdminDashboardOrders = () => {
  ...
  const [managementOderView, { data: managemantOderView, isLoading: isViewLoading, error: viewError }] =
    useManagementOderViewMutation()
  const [
    managementViewProjectDetails,
    { data: managemantViewProjectDetails, isLoading: isProjectLoading, error: projectError },
  ] = useManagementViewProjectDetailsMutation()
  const [managementOderCancel] = useManagementOderCancelMutation()
  const [managementOderPartial] = useManagementOderPartialMutation()
              ...
              <tbody>
                {managementOrders.map((order) => (
                  <tr key={order.id} className="border-b border-gray-300 text-sm">
                    ...
                    <td className="px-6 py-4">{renderStatus(order.status)}</td>
                    <td className="px-6 py-4 relative">
                      <button onClick={() => toggleActionList(order.id)} className="text-gray-400 hover:text-gray-600">
                        <MoreHorizontal className="h-5 w-5" />
                      </button>
                      {visibleActionList === order.id && (
                        <div
                        ...
                        >
                          ...
                          <NavLink to={`/Admin_Dashboard/order_Assessment/${order.id}`}>
                            <button
                  ...
                  <div className="flex flex-col gap-4 sm:flex-row sm:gap-2">
                    <div className="flex-1">
                      ...
                      <input
                        ...
                        placeholder="Enter seller percentage"
                        value={settlementData.seller_percentage}
                        onChange={(e) => setSettlementData((prev) => ({ ...prev, seller_percentage: e.target.value }))}
                        className="h-9 w-full rounded-md border border-[#0D95DD] px-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#0D95DD] focus:border-transparent"
                      />
                    </div>
                    <div className="flex-1">
                      ...
                      <input
                        ...
                        placeholder="Enter buyer percentage"
                        value={settlementData.buyer_percentage}
                        onChange={(e) => setSettlementData((prev) => ({ ...prev, buyer_percentage: e.target.value }))}
                        className="h-9 w-full rounded-md border border-[#0D95DD] px-3 text-sm focus:outline-none focus:ring-2 focus:ring-[#0D95DD] focus:border-transparent"
                      />
                    </div>
                  </div>
            ...
            >
              ...
              <div className="mb-6 p-4">
                {isViewLoading ? (
                  ...
                  <p className="text-sm text-red-500">{viewError?.data?.message || "Error loading delivery details"}</p>
                ) : managemantOderView ? (
                  <p className="text-sm text-gray-700">{managemantOderView.message}</p>
                ) : (
                  <p className="text-sm text-gray-700">No delivery details available</p>
                )}
              </div>
              <div className="flex flex-row gap-2 px-4">
                <button
          ...
          >
            ...
            >
              <div className="bg-[#0D95DD] px-6 py-4">
                <h1 className="text-white text-lg font-medium">View Project Details</h1>
              </div>
              <div className="p-6 max-h-[70vh] overflow-y-auto">
                {isProjectLoading ? (
                  ...
                  <div className="bg-red-50 border border-red-200 rounded-md p-4 text-red-600">
                    {projectError?.data?.message || "Error loading project details"}
                  </div>
                  ...
                  <div className="space-y-6">
                    <div className="bg-gray-50 rounded-lg p-5 border border-gray-200">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div className="space-y-3">
                          <div>
                            ...
                            <p className="text-sm font-medium text-gray-800">
                              {managemantViewProjectDetails.user.id || "N/A"}
                            </p>
                          </div>
                          <div>
                            <p className="text-sm font-medium text-gray-500">Name</p>
                            <p className="text-sm font-medium text-gray-800">
                              {managemantViewProjectDetails.user.name !== null
                                ? managemantViewProjectDetails.user.name
                                : "N/A"}
                            </p>
                          </div>
                          <div>
                            ...
                            <p className="text-sm font-medium text-gray-800">
                              {managemantViewProjectDetails.user.email || "N/A"}
                            </p>
                          </div>
                          <div>
                            <p className="text-sm font-medium text-gray-500">Username</p>
                            <p className="text-sm font-medium text-gray-800">
                              {managemantViewProjectDetails.user.username || "N/A"}
                            </p>
                          </div>
                          <div>
                            <p className="text-sm font-medium text-gray-500">Role</p>
                            <p className="text-sm font-medium text-gray-800">
                              {managemantViewProjectDetails.user.role || "N/A"}
                            </p>
                          </div>
                          <div>
                            <p className="text-sm font-medium text-gray-500">Staff Status</p>
                            <p className="text-sm font-medium text-gray-800">
                              {managemantViewProjectDetails.user.is_staff ? (
                        ...
                        <div className="space-y-3">
                          <div>
                            ...
                            <p className="text-sm font-medium text-gray-800">
                              {managemantViewProjectDetails.user.profession !== null
                                ? managemantViewProjectDetails.user.profession
                                : "N/A"}
                            </p>
                          </div>
                          <div>
                            ...
                            <p className="text-sm font-medium text-gray-800">
                              {managemantViewProjectDetails.user.about !== null
                                ? managemantViewProjectDetails.user.about
                                : "N/A"}
                            </p>
                          </div>
                          <div>
                            ...
                            <p className="text-sm font-medium text-gray-800">
                              {managemantViewProjectDetails.user.date_of_birth !== null
                                ? managemantViewProjectDetails.user.date_of_birth
                                : "N/A"}
                            </p>
                          </div>
                          <div>
                            ...
                            <p className="text-sm font-medium text-gray-800">
                              {managemantViewProjectDetails.user.years_of_experience !== null
                                ? managemantViewProjectDetails.user.years_of_experience
                                : "N/A"}
                            </p>
                          </div>
                          <div>
                            ...
                            <p className="text-sm font-medium text-gray-800">
                              {managemantViewProjectDetails.user.gender !== null
                                ? managemantViewProjectDetails.user.gender
                                : "N/A"}
                            </p>
                          </div>
                          <div>
                            ...
                            <p className="text-sm font-medium text-gray-800">
                              {managemantViewProjectDetails.user.is_subscribed ? (
                      ...
                      <div className="mt-4 space-y-3">
                        <div>
                          ...
                          <p className="text-sm font-medium text-gray-800">
                            {managemantViewProjectDetails.user.country !== null
                              ? managemantViewProjectDetails.user.country
                              : "N/A"}
                          </p>
                        </div>
                        <div>
                          <p className="text-sm font-medium text-gray-500">Residence Area</p>
                          <p className="text-sm font-medium text-gray-800">
                            {managemantViewProjectDetails.user.residence_area !== null
                              ? managemantViewProjectDetails.user.residence_area
                              : "N/A"}
                          </p>
                        </div>
                        <div>
                          ...
                          <p className="text-sm font-medium text-gray-800">
                            {managemantViewProjectDetails.user.hourly_rate !== null
                        ...
                        <div>
                          ...
                          <p className="text-sm font-medium text-gray-800">
                            {managemantViewProjectDetails.user.education !== null
                              ? managemantViewProjectDetails.user.education
                              : "N/A"}
                          </p>
                        </div>
                      </div>

                      {managemantViewProjectDetails.user.skills &&
                        managemantViewProjectDetails.user.skills.length > 0 ? (
                        <div className="mt-4">
                          <p className="text-sm font-medium text-gray-500 mb-2">Skills</p>
                          <div className="flex flex-wrap gap-2">
                            {managemantViewProjectDetails.user.skills.map((skill, index) => (
                              <span
                                key={index}
                      ...
                      {managemantViewProjectDetails.user.languages &&
                        managemantViewProjectDetails.user.languages.length > 0 ? (
                        <div className="mt-4">
                          <p className="text-sm font-medium text-gray-500 mb-2">Languages</p>
                          <div className="flex flex-wrap gap-2">
                            {managemantViewProjectDetails.user.languages.map((language, index) => (
                              <span
                                key={index}
                    ...
                    <div className="bg-gray-50 rounded-lg p-5 border border-gray-200">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div className="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                          <p className="text-sm font-medium text-gray-500">Rating Sum</p>
                          <p className="text-2xl font-bold text-[#0D95DD]">{managemantViewProjectDetails.rating_sum}</p>
                        </div>
                      </div>
                      {managemantViewProjectDetails.rating_count > 0 && (
                        <div className="mt-4 bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                          ...
                          <div className="flex items-center mt-1">
                            <p className="text-xl font-bold text-[#0D95DD] mr-2">
                              {(
                                managemantViewProjectDetails.rating_sum / managemantViewProjectDetails.rating_count
                              ).toFixed(1)}
                            </p>
