				...
				<table className="min-w-full rounded-md shadow-sm">
					...
					<tbody>
						{filteredOrders.map((order) => (
							<tr
								key={order.order_id}
								className="border-b border-[#C1DDEF] transition text-[#012939] text-[14px]"
							>
									...
									<div className="modal-box bg-[#EFF2F6] text-[#154153] pt-4 pb-6 px-6 w-[470px] py-10">
										...
										<div>
											...
											<div className="grid grid-cols-2 gap-3">
												<button className="py-2 px-4 border border-[#848239] rounded-md text-[#848239]">
													Edit
												</button>
												<button className="py-2 px-4 bg-[#848239] text-[#FFFFFF] rounded-md">
													Delete
												</button>
											</div>
										</div>
							...
							<div className="modal-box relative bg-[#EFF2F6] w-[566px] rounded px-6 py-10 text-[#154153]">
								...
								<div>
									...
									<div className="my-14">
										...
										<p className="text-sm text-slate-600">
											Lorem Ipsumis simply dummy text of
								...
								<div className="bg-white rounded-lg shadow-sm border border-gray-100 p-5">
									...
									<div className="flex justify-between items-center mb-4">
										<p className="text-gray-700">
											Budget 20USD/Per Hour (4 Person
											Required)
										</p>
										<p className="text-gray-700">
											Time:{" "}
